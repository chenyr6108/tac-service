...
/*
 * Add by Michael 2012 07-12
 * 导出重车相关合同
 */
public class ExpCarLeaseBackPDF extends AService {
	Log logger = LogFactory.getLog(ExpContract.class);
    /*
	 * Add by Michael 2012-7-12 导出重车回租融资租赁合同PDF
	 */
...
//				phrase.add(table);
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("本公司同意将下表机动车出售给裕融租赁有限公司", FontDefault2)); 
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 10));		
	    		i++; 
				...
				// 第一个子表开始,第一行
				// 租赁物的数量是动态增加的
				tT.addCell(makeCellSetColspan("序号/车辆",
						PdfPCell.ALIGN_LEFT, FontDefault2, 1));
				tT.addCell(makeCellSetColspan("机动车登记编号",
						PdfPCell.ALIGN_LEFT, FontDefault2, 1));
				tT.addCell(makeCellSetColspan("车辆类型",
						PdfPCell.ALIGN_LEFT, FontDefault2, 1));
				tT.addCell(makeCellSetColspan("车辆品牌",
						PdfPCell.ALIGN_LEFT, FontDefault2, 1));
				tT.addCell(makeCellSetColspan("车辆型号", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				tT.addCell(makeCellSetColspan("车身颜色", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				tT.addCell(makeCellSetColspan("车辆识别代号/车架号", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				tT.addCell(makeCellSetColspan("发动机号", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				tT.addCell(makeCellSetColspan("制造厂名称", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				tT.addCell(makeCellSetColspan("国产/进口", PdfPCell.ALIGN_LEFT,
						FontDefault2, 1));
				i++;

				for (int k = 0; k < leaseholds.size(); k++) {
					tT.addCell(makeCellSetColspan(
							String.valueOf(k+1), PdfPCell.ALIGN_LEFT, FontDefault222,
							1));
					tT.addCell(makeCellSetColspan(
							"null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_RIGSTER_NUMBER")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_RIGSTER_NUMBER")), PdfPCell.ALIGN_LEFT, FontDefault222,
							1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("THING_NAME")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("THING_NAME")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("THING_KIND")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("THING_KIND")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("MODEL_SPEC")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("MODEL_SPEC")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_COLOR")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_COLOR")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ID_NUMBER")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ID_NUMBER")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ENGINE_NUMBER")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ENGINE_NUMBER")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("MANUFACTURER")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("MANUFACTURER")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					tT.addCell(makeCellSetColspan("null".equals(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_IMPORT_DOMESTIC")))?"":String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_IMPORT_DOMESTIC")),
							PdfPCell.ALIGN_LEFT, FontDefault222, 1));
					i++;
				}
...
//				phrase.add(table);
			...
			BusinessLog.addBusinessLogWithIp(DataUtil
					.longUtil(context.contextMap.get("credit_id")), null,
					"导出 重车回租买卖合同", "合同浏览导出 重车回租买卖合同", null,
					context.contextMap.get("s_employeeName") + "("
							+ context.contextMap.get("s_employeeId")
							+ ")在合同管理的合同浏览使用导出合同功能", 1, DataUtil
							.longUtil(context.contextMap.get("s_employeeId")
	...
	try {   
	      ...
	      //购销合同编号
			...
			int i=0;
				...
				if("10".equals(contractType) || "12".equals(contractType)){
					tT.addCell(makeCellSetColspan2("关于车辆价款的支付指示",PdfPCell.ALIGN_CENTER, fa,7));
				}else{
	    		...
	    		if("10".equals(contractType) || "12".equals(contractType)){
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("户名：", PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
		    		
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("账号： ", PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
		    		
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("开户银行： ", PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
		    		
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("金额：   ", PdfPCell.ALIGN_LEFT, FontDefault2,5));
	//				tT.addCell(makeCellSetColspanNoBorder("元", PdfPCell.ALIGN_LEFT, FontDefaultTitle,3));
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
	    		}else{
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("户名："+bankInfo[0], PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
		    		
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("账号： "+bankInfo[1], PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
		    		
		    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
					tT.addCell(makeCellSetColspanNoBorder("开户银行： "+bankInfo[2], PdfPCell.ALIGN_LEFT, FontDefault2,5));		
		    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
		    		i++;
...
//				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,2));
   ...
   * @param context
   */
	 public void preThreeProtocolPdf(Context context){
			String[]  con = HTMLUtil.getParameterValues(context.getRequest(), "credit_idxx", "00");
			 ...
			 if(con != null ){
			   if(!(con[0].equals("00"))){
				 try {
		        		 if(con.length >1){
		        			 context.contextMap.put("credtdxx",  con);
		        			 this.getThreeProtocolDateMap(context);
		        		 }else{
		                	if(con.length ==1){
		                		 context.contextMap.put("credtdxx",   con);
		                		 this.getThreeProtocolDateMap(context);
   ...
   */
	 @SuppressWarnings("unchecked")
	public void  getThreeProtocolDateMap(Context context){
		 String[]  con = null;
		 ArrayList creditmapandleasehold=new ArrayList();
		  con= (String[]) context.contextMap.get("credtdxx");	        
	        for(int ii=0; ii< con.length;ii++){	
	        ...
	        this.expThreeProtocolPdfs(context,creditmapandleasehold);
	 }
 /**
  * 导出重车回租租赁物委托管理三方协议
  * @param context
  */
@SuppressWarnings("unchecked")
	public void expThreeProtocolPdfs(Context context,ArrayList creditmapandleasehold) {
...
//				phrase.add(table);
				...
				tT.addCell(makeCellSetColspanNoBorder("    ", PdfPCell.ALIGN_LEFT,
						FontDefault, 10));
				i++;
				tT.addCell(makeCellSetColspanNoBorder("租赁物委托管理三方协议", PdfPCell.ALIGN_CENTER,
						fa, 10));
				i++;
				tT.addCell(makeCellSetColspanNoBorder("    ", PdfPCell.ALIGN_RIGHT,
						FontDefault, 10));
				...
				tT.addCell(makeCellSetColspanNoBorder("",
						PdfPCell.ALIGN_LEFT, FontDefault,1));
				phrase = new Phrase("甲方（委托管理方、出租人）：", FontDefault2);
				phrase.add(new Phrase(Constants.COMPANY_NAME , FontUnde2)); 
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));
				tT.addCell(makeCellSetColspanNoBorder("",
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("乙方（被委托管理方）：", FontDefault2)); 
	    		phrase.add(new Phrase(custname , FontUnde2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));	
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("丙方(实际使用人)：", FontDefault2)); 
	    		phrase.add(new Phrase("________________________" , FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        基于甲、丙双方就下表租赁物，依据《中华人民共和国合同法》第十四章融资租赁", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("合同条款，签订了合同编号为", FontDefault2));
	    		phrase.add(new Phrase(Lcode+"", FontUnde2)); 
	    		phrase.add(new Phrase("的《融资租赁合同》，合同条款确认在丙方", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("未完全履行合同条款义务前，甲方保有下表租赁物的完全所有权，现据上述法律关系，", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("甲、乙、丙三方在符合相关法、规的前提，本于公平互惠原则及经充分沟通协调情况下，", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("就下表租赁物，委托管理相关事宜一致同意，并达成签订本协议条款：", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("租赁物详表（下称租赁物）：", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		for(int k=0;k<leaseholds.size();k++){
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(k+1), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_RIGSTER_NUMBER")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("THING_NAME")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("THING_KIND")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("MODEL_SPEC")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_COLOR")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ID_NUMBER")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_ENGINE_NUMBER")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan2NoBottomAndRight(String.valueOf(((HashMap)leaseholds.get(k)).get("MANUFACTURER")), PdfPCell.ALIGN_LEFT, FontDefault222,1));
					tT.addCell(makeCellSetColspan3(String.valueOf(((HashMap)leaseholds.get(k)).get("CAR_IMPORT_DOMESTIC")), PdfPCell.ALIGN_LEFT, FontDefault2,1));
		    		i++;
	    		}
	    		tT.addCell(makeCellSetColspan3WithNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,10));		
	    		i+=1;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("一、	甲方委托乙方的管理事项", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 				
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、	向丙方收取并代为缴纳管理租赁物的相关运营税、费。 ", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 	
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、	向丙方收取依据上述租赁物法律关系所应收取的相关保险费用，并向甲方指定的第 ", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    三方办理投保事项，并代丙方处理租赁物出险事故及后续所有保险理赔事宜。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    3、	向丙方收取租赁物相关行政管理费用，并代为办理包括但不限于检验、办证、 ", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    验证、换证等相关行政管理事项。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("二、	三方的权利义务", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    （一）、甲方 ", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、保有租赁物车辆的所有权，甲方向乙方提供以乙方为名义购买人的租赁物销售发票， ", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    但该销售发票仅作为乙方为租赁物车辆上牌、上户用，乙、丙方不得以此销售发票作", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    为租赁物车辆所有权的凭证。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、乙方、丙方同意甲方在本合同有效期间得将租赁物车辆权益为转让、处分等行为，但", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    对于受转让、处分的第三方，本协议对其有约束力。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    （二）、乙方", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、须善尽善良管理人责任，履行约定的管理事项。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、不干涉丙方对管理租赁物车辆的营运和使用，但对丙方营运的业务应给予适当的协", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    助。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     3、乙方不得侵害甲方对租赁物车辆的所有权，不得出现本协议第一条委托管理事项以外", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     的行为。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     4、管理租赁物车辆在营运过程中发生违法、违章、肇事、交通事故造成生命和财产损失", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     时，乙方不承担任何责任。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     5、丙方须按时向乙方缴纳委托管理费和第一条所述的费用，否则乙方有权单方面解除本", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     协议。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     6、丙方不得将管理的租赁物车辆，用于违法的目地使用，否则乙方有权单方面解除本协", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     议。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    （三）、丙方", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("      1、保有租赁物车辆的营运和收益权。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     2、对租赁物车辆的营运和收益须遵守相关法规，否则丙方对其违法、违章、肇事、交通", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     事故造成的生命和财产的损失承担全部的责任。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     3、依本协议条款规定按时向乙方缴纳相关的费用。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 	
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    4、在乙方依本协议对租赁物车辆实施管理时，须给予完全、适当的配合。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("三、委托管理期限", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、委托管理期限与甲、丙双方就租赁物车辆所签定的《融资租赁合同》一致，但若丙方", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    于《融资租赁合同》有效期间内未完全履行《融资租赁合同》和其他相关文件的义务时，", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    于租赁物车辆所有权不移转，委托管理期限顺延至丙方全面履行其义务之日止。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、若丙方提前清偿甲方租赁物车辆所有租金及完全履行《融资租赁合同》和其他相关文", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    件的义务时，则本协议效力亦终止，若丙方需续委托乙方管理时，由乙、丙双方另行签", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    订书面协议。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    3、管理的租赁物车辆，因灭失、毁损、等原因无法或无需再委托管理时，视为委托管理", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    期限终结。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("四、委托管理费用及支付", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、每一租赁物车辆的委托管理费为每月__________元人民币。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、本协议签署时，丙方应向乙方就每一租赁物车辆一次缴纳____个月的委托管理费共计", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    ________元人民币，或由乙、丙双方另行约定缴纳方式。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("五、违约责任", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、本协议履行过程中，由于乙方违约或其他可归责于乙方的事由，导致甲方损失的，乙", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 	
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    方应承担对甲方相应的损害赔偿责任。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、本协议履行过程中，由于丙方违约或其他可归责于丙方的事由，导致乙方损失的，丙", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    方应承担对乙方相应的损害赔偿责任。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    3、因任一方违反本协议致使本协议无法继续履行，他方可解除本协议，并向违反协议的", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    一方请求支付违约金__________元人民币。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    4、因不可抗力原因造成本协议无法履行或无履行实益的，甲、乙任何一方均有权解除本", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    协议，但须以书面通知他方，对解除本协议有争议的事项，双方具体协商解决。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("六、争议解决方式", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    于履行本协议或与本协议有关事项有所争议时，双方应先友好协商解决，协商不成时，以", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    甲方住所登记所在地法院为起诉管辖法院。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("七、其他规定", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    1、本协议一式三份，具同等的效力，甲、乙、丙三方各执乙份为凭，本协议自三方当事", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    人签字盖章之日起生效。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    2、本协议未尽事宜，三方可另行签署补充协议。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("甲方：", FontDefault2)); 
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontDefault2)); 
	    		phrase.add(new Phrase("（盖章）", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("法定代表人或授权代理人（签名）：", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("乙方（签名或盖章）：", FontDefault2)); 
	    		phrase.add(new Phrase(custname , FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("丙方（签名或盖章）：", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));	
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("签订日期：_______年___月___日", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
			...
			BusinessLog.addBusinessLogWithIp(DataUtil
					.longUtil(context.contextMap.get("credit_id")), null,
					"导出 重车回租三方协议", "合同浏览导出 重车回租三方协议", null,
					context.contextMap.get("s_employeeName") + "("
							+ context.contextMap.get("s_employeeId")
							+ ")在合同管理的合同浏览使用导出合同功能", 1, DataUtil
							.longUtil(context.contextMap.get("s_employeeId")
 ...
 * @param context
 */
	 public void preCarManageAgrementPdf(Context context){
			String[]  con = HTMLUtil.getParameterValues(context.getRequest(), "credit_idxx", "00");
			 ...
			 if(con != null ){
			   if(!(con[0].equals("00"))){
				 try {
		        		 if(con.length >1){
		        			 context.contextMap.put("credtdxx",  con);
		        			 this.getCarManageAgrementDateMap(context);
		        		 }else{
		                	if(con.length ==1){
		                		 context.contextMap.put("credtdxx",   con);
		                		 this.getCarManageAgrementDateMap(context);
 ...
 */
	 @SuppressWarnings("unchecked")
	public void  getCarManageAgrementDateMap(Context context){
		 String[]  con = null;
		 ArrayList creditmapandleasehold=new ArrayList();
		  con= (String[]) context.contextMap.get("credtdxx");	        
	        for(int ii=0; ii< con.length;ii++){	
	        ...
	        this.expCarManageAgrementPdfs(context,creditmapandleasehold);
	 }
/**
* 导出重车回租租赁物委托管理三方协议
* @param context
*/
@SuppressWarnings("unchecked")
	public void expCarManageAgrementPdfs(Context context,ArrayList creditmapandleasehold) {
...
//				phrase.add(table);
				...
				tT.addCell(makeCellSetColspanNoBorder("    ", PdfPCell.ALIGN_LEFT,
						FontDefault, 10));
				i++;
				tT.addCell(makeCellSetColspanNoBorder("车辆挂靠管理协议", PdfPCell.ALIGN_CENTER,
						fa, 10));
				i++;
				tT.addCell(makeCellSetColspanNoBorder("    ", PdfPCell.ALIGN_RIGHT,
						FontDefault, 10));
				...
				tT.addCell(makeCellSetColspanNoBorder("",
						PdfPCell.ALIGN_LEFT, FontDefault,1));
				phrase = new Phrase("甲方：", FontDefault2);
				phrase.add(new Phrase(Constants.COMPANY_NAME , FontUnde2)); 
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));
				tT.addCell(makeCellSetColspanNoBorder("",
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("乙方：", FontDefault2)); 
	    		phrase.add(new Phrase(custname , FontUnde2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));	
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("      甲、乙双方在友好、公平的基础上，依据《中华人民共和国合同法》及其他" , FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("相关法令，经充分协商及合于法令的前提下，就车辆挂靠管理相关事宜，达成如", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("下协议条款,以资共同遵守：", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("一、挂靠车辆：指甲方客户在甲方处以融资租赁形式购买的各式重型车辆，经甲", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("方同意由客户挂靠于乙方处管理的车辆。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("二、双方的权利与义务", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    （一）、甲方的权利与义务", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 				
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        1、在甲方、乙方及甲方客户三方签订的车辆《租赁物委托管理三方协议》", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 	
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        有效期间内，甲方于任何情况下拥有融资租赁车辆的所有权，有权保管", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        车辆登记证书、发票及其他车辆相关证书原件。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        2、如乙方存在侵害融资租赁车辆的所有权行为或因乙方原因有有可能侵害", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        甲方对融资租赁车辆的所有权时，甲方有权在不经通知乙方的情况下，", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        自行或委托第三人取回融资租赁车辆，并于取回后有权处分融资租赁车辆。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("    （二）、乙方的权利与义务", FontColumn2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        1、协助甲方的融资租赁客户开展正常的经营业务，并不得干涉、妨碍其正", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        常的营业性活动。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        2、有权向甲方的融资租赁客户收取合理的挂靠费及签订相关的挂靠文件。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        3、督导及协助甲方的融资租赁客户，按时缴纳所有法定的包括但不限于运", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        管费、车船税、二级维户费等相关税、费。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        4、督导及协助甲方的融资租赁客户，完成挂靠车辆的年检及相关法令规定", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        的检修、行政管理事宜。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        5、协助甲方及甲方的融资租赁客户，处理车辆各种保险、出险理赔事宜及", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        其他交通事故的处理。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        6、不得私自对本协议挂靠的车辆，实行买卖、抵押、质押、抵销债务、过", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        户、转让或其他侵害甲方车辆所有权的行为，前述车辆如需过户、年检，", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        须则乙方必须实时通知甲方并经甲方出具书面通知同意书后，始可进行", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        办理的手续。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        7、协助甲方对逾期缴纳租金及违反上述《融资租赁合同》规定客户的管理", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        及车辆取回等其他的保障债权实施的措施，并对甲方取回的车辆根据甲", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        方的需要，无条件协助甲方办理相关包括但不限于报停、移转过户等行", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        政管理手续。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        8、挂靠车辆的融资租赁合同终止后，由甲方出具相关书面证明予乙方，后", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("        续车辆的管理，由乙方自行与客户协议，不与甲方产生任何关系。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("三、签订《租赁物委托管理三方协议》", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     就客户透过甲方融资租赁形式，于乙方处挂靠的每一台车辆，须由甲方、乙方及", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     客户三方另行签定《租赁物委托管理三方协议》。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 	
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("四、违约责任", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     （一）、本协议履行过程中，由于甲方违约及其他可归责于甲方事由，致乙方", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     受有损害的，甲方应承担相应的损害赔偿责任。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++;
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     （二）、本协议履行过程中，由于乙方违约及其他可归责于乙方事由，致甲方", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("     受有损害的，乙方应承担相应的损害赔偿责任。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		...
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("五、本于公平、互利的真诚长久合作，乙方及其法定代表人，保证双方于协议合", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("作期间，就甲方客户透过融资租赁形式，于乙方处挂靠的每一台车辆，客户的权", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("益及甲方的所有权益不受侵害，若有侵害行为导致损害的，愿承担相应的民、刑", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("事法律责任。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("六、本协议有效期限为长期有效，甲、乙双方不得无故终止协议，否则应承担相", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("应的法律责任，双方若需终止本协议，须另行书面签定终止的协议书,如因乙方", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("原因单方解除本协议而造成客户及甲方利益的损害,由乙方全部赔偿责任。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("七、本协议未尽事宜，双方可另行签订补充协议，对本协议产生争议时，双方应", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("先友好协商解决，协商不成时以甲方登记住所所在地法院为管辖法院。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
	    		i++; 
	    		phrase = new Phrase("", FontDefault2);  
	    		phrase.add(new Phrase("八、本协议一式三份，甲、乙双方及乙方代表人各执一份为凭。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
				tT.addCell(makeCellSetColspanNoBorder(phrase,
						PdfPCell.ALIGN_LEFT, FontDefault2, 8));		
	    		tT.addCell(makeCellSetColspanNoBorder("",PdfPCell.ALIGN_LEFT, FontDefault,1));
			...
			document.close();
			// 支付表PDF名字的定义
			String strFileName = "carLeaseBackAgrement.pdf";
			context.response.setContentType("application/pdf");
			context.response.setCharacterEncoding("UTF-8");
			context.response.setHeader("Pragma", "public");
			context.response.setHeader("Cache-Control",
			...
			BusinessLog.addBusinessLogWithIp(DataUtil
					.longUtil(context.contextMap.get("credit_id")), null,
					"导出 重车回租车辆挂靠管理协议", "合同浏览导出 重车回租车辆挂靠管理协议", null,
					context.contextMap.get("s_employeeName") + "("
							+ context.contextMap.get("s_employeeId")
							+ ")在合同管理的合同浏览使用导出合同功能", 1, DataUtil
							.longUtil(context.contextMap.get("s_employeeId")
  ...
  * @param context
  */
	 public void preCallLineGrantBookPdf(Context context){
			String[]  con = HTMLUtil.getParameterValues(context.getRequest(), "credit_idxx", "00");
			 ...
			 if(con != null ){
			   if(!(con[0].equals("00"))){
				 try {
		        		 if(con.length >1){
		        			 context.contextMap.put("credtdxx",  con);
		        			 this.getCallLineGrantBookDateMap(context);
		        		 }else{
		                	if(con.length ==1){
		                		 context.contextMap.put("credtdxx",   con);
		                		 this.getCallLineGrantBookDateMap(context);
  ...
  */
	 @SuppressWarnings("unchecked")
	public void  getCallLineGrantBookDateMap(Context context){
		 String[]  con = null;
		 ArrayList creditmapandleasehold=new ArrayList();
		  con= (String[]) context.contextMap.get("credtdxx");	        
	        for(int ii=0; ii< con.length;ii++){	
	        ...
	        this.expCallLineGrantBookPdfs(context,creditmapandleasehold);
	 }
/**
 * 导出重车回租挂靠行授权书
 * @param context
 */
public void expCallLineGrantBookPdfs(Context context,ArrayList creditmapandleasehold) {
	...
	try {   
 		...
 		float[] widthsStl = {0.1f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.1f};
			...
			int i=0;
				...
				tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_LEFT, FontDefault,12)); 
				i++;
				tT.addCell(makeCellSetColspan2("授                权                书",PdfPCell.ALIGN_CENTER, fa,12));
				i++;
				tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_LEFT, FontDefault,12));
				i++;
	    		tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_RIGHT, FontDefault,12));
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		Phrase phrase = new Phrase("        鉴于本司与", FontDefault2); 
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2)); 
	    		phrase.add(new Phrase("及向其以融资租赁形式承租租赁物的承租人签订的《租赁物委托", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2);
	    		phrase.add(new Phrase("管理三方协议》，及", FontDefault2));
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2));
	    		phrase.add(new Phrase("于 ____年 ____月 ____日与", FontDefault2));
	    		phrase.add(new Phrase(custname, FontUnde2)); 
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("签订的合同编号为 ", FontDefault2));
	    		phrase.add(new Phrase(Lcode, FontUnde2));
	    		phrase.add(new Phrase("的《融资租赁合同》，本司同意并授权与", FontDefault2));
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("就下列租赁物：", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("如承租人有迟延缴纳租金或其他违反上述协议及合同的行为，依上述协议及合同条款，", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		...
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2));
	    		phrase.add(new Phrase("有权解除合同并取回该租赁物，并同意", FontDefault2));
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2)); 	
	    		phrase.add(new Phrase("可收回挂靠于", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("我司的该租赁物及享有对该租赁物的全权处分权，且就处分后的所得及收益全归", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		...
	    		phrase = new Phrase("", FontDefault2); 	    		
	    		phrase.add(new Phrase(Constants.COMPANY_NAME, FontUnde2)); 
	    		phrase.add(new Phrase("所有。", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder("特此授权", PdfPCell.ALIGN_LEFT, FontDefault2,10));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder("授权人："+custname, PdfPCell.ALIGN_LEFT, FontDefault2,10));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    			    		
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder("法定代表人/授权代表人：", PdfPCell.ALIGN_LEFT, FontDefault2,10));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,10));
	    		...
	    		i+=1;
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder("日期:        年       月       日", PdfPCell.ALIGN_LEFT, FontDefault2,10));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=4 ;
	    		if(i<53){
	    			for(;i<40;i++){
			...
			document.close();
	    // 支付表PDF名字的定义
	    String strFileName =  "CallLineGrantBook.pdf";
	    context.response.setContentType("application/pdf");
	    context.response.setCharacterEncoding("UTF-8");
	    context.response.setHeader("Pragma", "public");
	    context.response.setHeader("Cache-Control",
 ...
 * @param context
 */
	 public void preCarLeaseBackStatementPdf(Context context){
			String[]  con = HTMLUtil.getParameterValues(context.getRequest(), "credit_idxx", "00");
			 ...
			 if(con != null ){
			   if(!(con[0].equals("00"))){
				 try {
		        		 if(con.length >1){
		        			 context.contextMap.put("credtdxx",  con);
		        			 this.getCarLeaseBackStatementDateMap(context);
		        		 }else{
		                	if(con.length ==1){
		                		 context.contextMap.put("credtdxx",   con);
		                		 this.getCarLeaseBackStatementDateMap(context);
 ...
 */
	 @SuppressWarnings("unchecked")
	public void  getCarLeaseBackStatementDateMap(Context context){
		 String[]  con = null;
		 ArrayList creditmapandleasehold=new ArrayList();
		  con= (String[]) context.contextMap.get("credtdxx");	        
	        for(int ii=0; ii< con.length;ii++){	
	        ...
	        this.expCarLeaseBackStatementPdfs(context,creditmapandleasehold);
	 }
/**
* 导出重车回租声 明 书
* @param context
*/
public void expCarLeaseBackStatementPdfs(Context context,ArrayList creditmapandleasehold) {
	...
	try {   
		...
		float[] widthsStl = {0.1f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.1f};
			...
			int i=0;
				...
				tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_LEFT, FontDefault,12)); 
				i++;
				tT.addCell(makeCellSetColspan2("声                明                书",PdfPCell.ALIGN_CENTER, fa,12));
				i++;
				tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_LEFT, FontDefault,12));
				i++;
	    		tT.addCell(makeCellSetColspan2("    ",PdfPCell.ALIGN_RIGHT, FontDefault,12));
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		Phrase phrase = new Phrase("立声明书人:", FontDefault2); 
	    		//为客户名称加入下划线
	    		phrase.add(new Phrase(custname+"", FontUnde2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		...
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("        ", FontDefault2)); 
	    		phrase.add(new Phrase("声明就本司为与贵司办理融资租赁售后租回业务,于", FontDefault2)); 
	    		phrase.add(new Phrase("______年", FontDefault2)); 
	    		phrase.add(new Phrase("____月____日与贵司签定合同号为", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase(Lcode, FontUnde2)); 
	    		phrase.add(new Phrase("的《融资租赁合同》及合同号为", FontDefault2));
	    		phrase.add(new Phrase(Lcode, FontUnde2));  
	    		phrase.add(new Phrase("的《买卖合同》项下的融资租赁", FontDefault2));
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("标的物（如下表），确认系本司自有,绝非第三人靠行的车辆,如有不实,愿负相关民、刑事法律责任,", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		phrase = new Phrase("", FontDefault2); 
	    		phrase.add(new Phrase("特立此声明书为证。", FontDefault2)); 
	    		tT.addCell(makeCellSetColspanNoBorder(phrase, PdfPCell.ALIGN_LEFT, FontDefault2,10));	
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i++;
	    		...
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,1));
				tT.addCell(makeCellSetColspanNoBorder("        此致", PdfPCell.ALIGN_LEFT, FontDefault2,9));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,1));
				tT.addCell(makeCellSetColspanNoBorder(Constants.COMPANY_NAME, PdfPCell.ALIGN_LEFT, FontDefault2,9));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanWithNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,10));		
	    		tT.addCell(makeCellWithBorderRight("      ",PdfPCell.ALIGN_LEFT, FontDefault));	
	    		i+=1;	    		
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanWithNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,10));		
				...
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,1));
				tT.addCell(makeCellSetColspanNoBorder("", PdfPCell.ALIGN_LEFT, FontDefault2,4));
				tT.addCell(makeCellSetColspanNoBorder(" 立声明书人："+custname+"", PdfPCell.ALIGN_LEFT, FontDefault2,5));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
				...
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,1));
				tT.addCell(makeCellSetColspanNoBorder("", PdfPCell.ALIGN_LEFT, FontDefault2,4));
				tT.addCell(makeCellSetColspanNoBorder(" 法定代表人/授权代表人：", PdfPCell.ALIGN_LEFT, FontDefault2,5));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=1;
	    		tT.addCell(makeCellWithBorderLeft("      ",PdfPCell.ALIGN_LEFT, FontDefault));
				tT.addCell(makeCellSetColspanNoBorder(" ", PdfPCell.ALIGN_LEFT, FontDefault2,1));
				tT.addCell(makeCellSetColspanNoBorder("", PdfPCell.ALIGN_LEFT, FontDefault2,4));
				tT.addCell(makeCellSetColspanNoBorder(" 日期：             年        月       日", PdfPCell.ALIGN_LEFT, FontDefault2,5));
	    		tT.addCell(makeCellWithBorderRight("  ",PdfPCell.ALIGN_LEFT, FontDefault));
	    		i+=2;
			...
			document.close();
	    // 支付表PDF名字的定义
	    String strFileName =  "CarLeaseBackStatement.pdf";
	    context.response.setContentType("application/pdf");
	    context.response.setCharacterEncoding("UTF-8");
	    context.response.setHeader("Pragma", "public");
	    context.response.setHeader("Cache-Control",
...
//				}
		...
		try {
			...
			for(int bookint=0;bookint<booknotes.size();bookint++){
				...
				for(int i=0;i<equipmentsList.size();i++){
					...
					tT2.addCell(makeCellWithBorder("发动机号:"+(equipmentsList.get(i).get("CAR_ENGINE_NUMBER")==null?"":equipmentsList.get(i).get("CAR_ENGINE_NUMBER")) , PdfPCell.ALIGN_LEFT, FontDefault,1));
					tT2.addCell(makeCellWithBorderRightP("含税金额: "+updateMon(equipmentsList.get(i).get("SHUI_PRICE")==null?"":equipmentsList.get(i).get("SHUI_PRICE")) , PdfPCell.ALIGN_LEFT, FontDefault,cnt2));	
				...
				float[] widthsStl2 = {2,2,4};
				ctable.setWidths(widthsStl2);
				Phrase objPhase = new Phrase("3、出租人购买租赁物的成本【含税价】", FontColumn);
				PdfPCell objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    objCell.setRowspan(3);
			    objCell.setBorderWidthBottom(0);
			    objCell.setBorderWidthLeft(1f);
			    objCell.setBorderWidthRight(0);
			    objCell.setBorderWidthTop(0);
			    ctable.addCell(objCell);
			    
			    objPhase = new Phrase("购买价格", FontDefault);
			    objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    ...
			    objPhase = new Phrase("人民币￥" + updateMon(LeaseUtil.getTotalPriceByCreditId((String)context.contextMap.get("credit_id"))), FontDefault);
			    objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    ...
			    objPhase = new Phrase("其他费用", FontDefault);
			    objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    ...
			    objPhase = new Phrase("人民币￥", FontDefault);
			    objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    ...
			    objPhase = new Phrase("合计", FontDefault);
			    objCell = new PdfPCell(objPhase);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setFixedHeight(20);
			    ...
			    objCell = new PdfPCell();
			 

			    objCell.setFixedHeight(60);
			    objCell.setBorderWidthBottom(1f);
			    objCell.setBorderWidthLeft(1);
			    objCell.setBorderWidthRight(1f);
			    objCell.setBorderWidthTop(0);
			    objCell.addElement(ctable);
			    objCell.setColspan(2);
			    objCell.setPaddingBottom(0);
			    objCell.setPaddingTop(0);
			    objCell.setPaddingLeft(0);
			    objCell.setPaddingRight(0);
			    objCell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
			    objCell.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
			    tT2.addCell(objCell);
				...
				tT2.addCell(makeCellSetColspanNoBorderTOP("4、租 赁 物 放 置 场 所 ", PdfPCell.ALIGN_LEFT, FontColumn,2));
				tT2.addCell(makeCellSetColspanLRBorder("公 司 名 称 ："+((creditCustomerMap==null||creditCustomerMap.get("CUST_NAME")==null)?"":creditCustomerMap.get("CUST_NAME")) , PdfPCell.ALIGN_LEFT, FontDefault,2));
				tT2.addCell(makeCellSetColspanLRBorder("公 司 地 址 ："+((creditCustomerMap==null||creditCustomerMap.get("CORP_REGISTE_ADDRESS")==null)?"":creditCustomerMap.get("CORP_REGISTE_ADDRESS")), PdfPCell.ALIGN_LEFT, FontDefault,2));
				tT2.addCell(makeCellSetColspanLRBorder("租 赁 物 放 置 地 址 ："+((creditCustomerMap==null||creditCustomerMap.get("EQUPMENT_ADDRESS")==null)?"":creditCustomerMap.get("EQUPMENT_ADDRESS")), PdfPCell.ALIGN_LEFT, FontDefault,2));
				tT2.addCell(makeCellSetColspanNoBorderTOPAuto("使用区域 ："+((creditCustomerMap==null||creditCustomerMap.get("EQUPMENT_ADDRESS")==null)?"":creditCustomerMap.get("EQUPMENT_ADDRESS")), PdfPCell.ALIGN_LEFT, FontDefault,2,compAdd_cnt));
				...
				tT2.addCell(makeCellSetColspanNoBorderTOP("5、租 赁 期 间 及 租 金", PdfPCell.ALIGN_LEFT, FontColumn,2));
				...
				tT2.addCell(makeCellCOS("6、交 付 预 定 日 及 验 收 期 限", PdfPCell.ALIGN_LEFT, FontColumn,2));
				tT2.addCell(makeCellSetColspanLRBorder("    交 付 预 定 日 ："+schemeMap.get("START_DATE").toString().substring(0, 4)+"年____月" , PdfPCell.ALIGN_LEFT, FontDefault,2));
				tT2.addCell(makeCellSetColspanLRBorder("    验 收 期 限 ：交付日后3天内", PdfPCell.ALIGN_LEFT, FontDefault,2));
				t=t+3;			
				tT2.addCell(makeCellCOS("7、保 证 金", PdfPCell.ALIGN_LEFT, FontColumn,2));

				tT2.addCell(makeCellSetColspanNoBorderTOP("    (1)RMB【"+   updateMon(schemeMap.get("PLEDGE_AVE_PRICE")+"") +"】元（平均抵充） 。"+"    (2)RMB【"+   updateMon(schemeMap.get("PLEDGE_BACK_PRICE")+"") +"】元（期末无息返还） 。", PdfPCell.ALIGN_LEFT, FontDefault,2));
				t=t+2; 
				
				tT2.addCell(makeCellSetColspanNoBorderTOP("8、租 金 支 付 方 法 及 方 式", PdfPCell.ALIGN_LEFT, FontColumn,2));
				t=t+1;
				...
				tT2.addCell(makeCellCOS("9、租 期 结 束 后 的 购 买 选 择 权", PdfPCell.ALIGN_LEFT, FontColumn,2));
				tT2.addCell(makeCellSetColspanNoBorderTOP("    RMB【"+updateMoney(stayBuyPrice, nfFSNum)+"】元", PdfPCell.ALIGN_LEFT, FontDefault,2));
				 
				t=t+2;
				int lenn2 = irrMonthPaylines.size();
				
				tT2.addCell(makeCellSetColspanNoBorderTOP("10、附 属 条 款 " , PdfPCell.ALIGN_LEFT, FontColumn,2));
				t++;
 				if(t==39||(t-39)%38==0){
 					tT2.addCell(makeCellSetColspanNoBorderTOP("    保证金用于最后抵冲含税金额/期数:【"+updateMon(DataUtil.doubleUtil(paylist.get("PLEDGE_LAST_PRICE"))+DataUtil.doubleUtil(paylist.get("PLEDGE_LAST_PRICE_TAX")))+"】元/"+paylist.get("PLEDGE_LAST_PERIOD")+"期", PdfPCell.ALIGN_LEFT, FontDefault,2));
 				}
	...
	public void expCarLeaseBackZulwToPdf_new(Context context) {
		...
		//Add by Michael 导出重车回租租赁物情况表  For 增值税
