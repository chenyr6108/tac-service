...
//			number=new Number(9,n,Double.parseDouble(real_sum_bili),pcellFormat_right);
			...
			cell=new Label(2,n,obj1.get("S_START_DATE")+"~"+obj1.get("PROJECT_ITEM"),dateCellFormat_left);
			sheet.addCell(cell);
			cell=new Label(3,n,"",format3); 
			sheet.addCell(cell); 
			...
			cell=new Label(5,n,obj2.get("S_START_DATE")+"~"+obj2.get("PROJECT_ITEM"),dateCellFormat_left);
			sheet.addCell(cell);
			cell=new Label(6,n,"",format3); 
			sheet.addCell(cell); 
			...
			cell=new Label(8,n,obj3.get("S_START_DATE")+"~"+obj3.get("PROJECT_ITEM"),dateCellFormat_left);
			sheet.addCell(cell);
			cell=new Label(9,n,"",format3); 
			sheet.addCell(cell); 
			sheet.setRowView(n,300,false); 
...
//			number=new Number(6,n,Double.parseDouble(zongzichanhuolilv3),pcellFormat_center2);
	...
	public ByteArrayOutputStream exportExcel2(Map<String,String> exportMap) throws Exception {
		
		workbookSettings.setEncoding("ISO-8859-1");
		WritableSheet sheet=wb.createSheet("BSPL-1",1);
		...
		WritableFont font7 = new WritableFont(WritableFont.createFont("宋体"), 10, WritableFont.NO_BOLD);
		font7.setColour(Colour.BLUE);
		WritableCellFormat format7 = new WritableCellFormat(font7);
		format7.setAlignment(Alignment.LEFT); 
		...
		sheet.addCell(cell); 
		SimpleDateFormat df=new SimpleDateFormat("yyyy-MM-dd");
		Date PROJECT_ITEM1=df.parse(exportMap.get("toExcelRow1Col2")+"");
		DateTime dateLabel=new DateTime(2,n, PROJECT_ITEM1,dateCellFormat_left);
		sheet.addCell(dateLabel);
		cell=new Label(3,n,"",format3); 
		sheet.addCell(cell); 
		cell=new Label(4,n,"两期差异",format3); 
		sheet.addCell(cell);
		Date PROJECT_ITEM2=df.parse(exportMap.get("toExcelRow1Col5")+"");
		DateTime dateLabe2=new DateTime(5,n, PROJECT_ITEM2,dateCellFormat_left);
		sheet.addCell(dateLabe2);
		cell=new Label(6,n,"",format3); 
		sheet.addCell(cell); 
		cell=new Label(7,n,"两期差异",format3); 
		sheet.addCell(cell);
		Date PROJECT_ITEM3=df.parse(exportMap.get("toExcelRow1Col8")+"");
		DateTime dateLabe3=new DateTime(8,n, PROJECT_ITEM3,dateCellFormat_left);
		sheet.addCell(dateLabe3);
		cell=new Label(9,n,"",format3); 
		sheet.addCell(cell); 
		...
		cell=new Label(0,n,""); 
		sheet.addCell(cell); 
		cell=new Label(1,n,exportMap.get("toExcelRow"+row+"Col1"),format3); 
		sheet.addCell(cell); 
		cell=new Label(2,n,exportMap.get("toExcelRow"+row+"Col2"),ccellFormat_right);
		sheet.addCell(cell);		
		cell=new Label(3,n,exportMap.get("toExcelRow"+row+"Col3"),pcellFormat_right);
		sheet.addCell(cell);
		cell=new Label(4,n,exportMap.get("toExcelRow"+row+"Col4"),ccellFormat_right);
		sheet.addCell(cell);
		cell=new Label(5,n,exportMap.get("toExcelRow"+row+"Col5"),ccellFormat_right);
		sheet.addCell(cell);
		cell=new Label(6,n,exportMap.get("toExcelRow"+row+"Col6"),pcellFormat_right);
		sheet.addCell(cell);
		cell=new Label(7,n,exportMap.get("toExcelRow"+row+"Col7"),ccellFormat_right);
		sheet.addCell(cell);
		cell=new Label(8,n,exportMap.get("toExcelRow"+row+"Col8"),ccellFormat_right);
		sheet.addCell(cell);

		cell=new Label(9,n,exportMap.get("toExcelRow"+row+"Col9"),pcellFormat_right);
		sheet.addCell(cell);
		sheet.setRowView(n,300,false);
		n=n+1;
		row++;
		
		cell=new Label(0,n,"");//row=3
		sheet.addCell(cell); 
		cell=new Label(1,n,exportMap.get("toExcelRow"+row+"Col1"),format3); 
		sheet.addCell(cell); 
		cell=new Label(2,n,exportMap.get("toExcelRow"+row+"Col2"),ccellFormat_right);
		...
		cell=new Label(0,n,"");//row=9
		sheet.addCell(cell); 
		cell=new Label(1,n,exportMap.get("toExcelRow"+row+"Col1"),format7);
		sheet.addCell(cell); 
		cell=new Label(2,n,exportMap.get("toExcelRow"+row+"Col2"),ccellFormat_right);
		sheet.addCell(cell);		
		cell=new Label(3,n,exportMap.get("toExcelRow"+row+"Col3"),pcellFormat_right);
		...
		cell=new Label(0,n,"");//row=21
		sheet.addCell(cell); 
		cell=new Label(1,n,exportMap.get("toExcelRow"+row+"Col1"),format8); 
		sheet.addCell(cell); 
		cell=new Label(2,n,exportMap.get("toExcelRow"+row+"Col2"),ccellFormat_right);
		sheet.addCell(cell);		
		cell=new Label(3,n,exportMap.get("toExcelRow"+row+"Col3"),pcellFormat_right);
		...
		cell=new Label(0,n,""); //row=41
		sheet.addCell(cell); 
		cell=new Label(1,n,"科目\\日期 ",format3); 
		sheet.addCell(cell); 
		
		cell=new Label(2,n,exportMap.get("toExcelRow"+row+"Col2")+"~"+exportMap.get("toExcelRow"+row+"Col3"),dateCellFormat_left);
		sheet.addCell(cell);
		cell=new Label(3,n,"",format3); 
		sheet.addCell(cell); 
		cell=new Label(4,n,"成长率%",format3); 
		sheet.addCell(cell);
		cell=new Label(5,n,exportMap.get("toExcelRow"+row+"Col5")+"~"+exportMap.get("toExcelRow"+row+"Col6"),dateCellFormat_left);
		sheet.addCell(cell);
		cell=new Label(6,n,"",format3); 
		sheet.addCell(cell); 
		cell=new Label(7,n,"成长率%",format3); 
		sheet.addCell(cell);
		cell=new Label(8,n,exportMap.get("toExcelRow"+row+"Col8")+"~"+exportMap.get("toExcelRow"+row+"Col9"),dateCellFormat_left);
		sheet.addCell(cell);
		cell=new Label(9,n,"",format3); 
		sheet.addCell(cell); 
		sheet.setRowView(n,300,false); 
		...
		//计算RATIO 
		List<Map> vouchReportLists=(List<Map>)DataAccessor.query("creditVoucher.getVoucherReports2", exportMap, DataAccessor.RS_TYPE.LIST);
		...
		if(vouchReportLists.size()>0){
			obj1=vouchReportLists.get(0);
			obj2=vouchReportLists.get(1);
			obj3=vouchReportLists.get(2);
		}
		
		Map<String, Map> exportMap1 = new HashMap<String, Map>();
		//计算第一页 sum值
		...
		exportMap1.put("obj1", obj1);
		exportMap1.put("obj2", obj2);
		exportMap1.put("obj3", obj3);
		
		//计算第一页 比率及差异
		CreditReport.initAllData(exportMap1);
		
		//计算第二页 比率 成长率
		CreditReport.initTable2Data(exportMap1);
		
		//计算第三页 需要数据
		CreditReport.ratio(exportMap1);
		
		bili1 = exportMap1.get("bili1");
		bili2 = exportMap1.get("bili2");
		bili3 = exportMap1.get("bili3");
		...
		ratio1 = exportMap1.get("ratio1");
		ratio2 = exportMap1.get("ratio2");
		ratio3 = exportMap1.get("ratio3");
