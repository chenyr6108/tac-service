...
public class CreditVouchService extends AService {
	...
	public void getCreditVouchers(Context context) throws SQLException {
...
//			Output.jspOutput(outputMap, context, "/credit/creditFrame.jsp");
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void addCreditCorp(Context context) throws SQLException {
...
//			DataAccessor.execute("creditVoucher.createCreditCorpBankAccount", context.contextMap,DataAccessor.OPERATION_TYPE.INSERT);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void addCreditCorpForSupport(Context context) {
		...
		try {
			...
			String changeContent = "增加担保人["+context.contextMap.get("CORP_NAME_CN")+"]的信息";
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(context.contextMap.get("credit_id")),null, 
					"业务支撑", "担保人维护", "", changeContent, 1, DataUtil.longUtil(context.contextMap
...
//			DataAccessor.execute("creditVoucher.createCreditCorpBankAccount", context.contextMap,DataAccessor.OPERATION_TYPE.INSERT);
		...
		Output.jspOutput(outputMap, context, "/servlet/defaultDispatcher?__action=creditVoucher.getCreditVouchersShowForSupport&credit_id="+context.contextMap.get("credit_id")+"&commit_flag=2");
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void addCreditNatu(Context context) throws SQLException {
...
//					DataAccessor.OPERATION_TYPE.INSERT).toString());
			// 是联合担保
			if (istogether == 1 && LeaseUtil.getCreditNatuByName(String.valueOf(context.contextMap.get("credit_id")), String.valueOf(context.contextMap.get("natu_mate_name"))) == 0) {
...
//					DataAccessor.execute("creditVoucher.createProperty", map4, DataAccessor.OPERATION_TYPE.INSERT);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void addCreditNatuForSupport(Context context) {
		int istogether = Integer.parseInt(context.contextMap.get("istogether")
				.toString());
		List errList = context.errList ;
		Map outputMap = new HashMap() ;
...
//					DataAccessor.OPERATION_TYPE.INSERT).toString());
			// 是联合担保
			String changeContent = "增加担保人["+context.contextMap.get("cust_name")+"]的信息";
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(context.contextMap.get("credit_id")),null, 
					"业务支撑", "担保人维护", "", changeContent, 1, DataUtil.longUtil(context.contextMap
							.get("s_employeeId")), null, context.contextMap.get("IP").toString());
...
//					DataAccessor.execute("creditVoucher.createProperty", map4, DataAccessor.OPERATION_TYPE.INSERT);
	...
	public void deleteCorp(Context context) {
		...
		try {
			...
			Map oldData = (Map) DataAccessor.query("creditVoucher.getCreditCustomerCorpById", context.contextMap, RS_TYPE.OBJECT);
			
			String changeContent = "删除担保人["+oldData.get("CORP_NAME_CN")+"]";
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(oldData.get("PRCD_ID")),null, 
					"业务支撑", "担保人维护/报告管理", "", changeContent, 1, DataUtil.longUtil(context.contextMap
							.get("s_employeeId")), null, context.contextMap.get("IP").toString());
	...
	public void deleteCropProperty(Context context) {
		...
		if(errList.isEmpty()){
			Output.jspSendRedirect(context, 
					"defaultDispatcher?__action=creditVoucher.getCreditVouchers&credit_id="
	...
	public void deleteNatu(Context context) {
		...
		try {
			...
			Map oldData = (Map) DataAccessor.query("creditVoucher.getCreditVoucherNatuById", context.contextMap, RS_TYPE.OBJECT);
			
			String changeContent = "删除担保人["+oldData.get("CUST_NAME")+"]";
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(oldData.get("PRCD_ID")),null, 
					"业务支撑", "担保人维护/报告管理", "", changeContent, 1, DataUtil.longUtil(context.contextMap
							.get("s_employeeId")), null, context.contextMap.get("IP").toString());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void getCreditVouchersShow(Context context) throws SQLException {
		Map outputMap = new HashMap();
		List corpList = null;
		List natuList = null;
		Map creditMap = null;
...
//			}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void getCreditVouchersShowForSupport(Context context) {
		Map outputMap = new HashMap();
		List corpList = null;
		List natuList = null;
		Map creditMap = null;
		...
		outputMap.put("prcd_id", context.contextMap.get("credit_id"));
		if(errList.isEmpty()){
			if (DataUtil.intUtil(context.contextMap.get("commit_flag")) == 2) {
				outputMap.put("commit_flag", context.contextMap.get("commit_flag"));
				Output.jspOutput(outputMap, context,
						"/support/supportGuarantorForUpdate.jsp");
			} else {
				outputMap.put("flag", "show");//查看
				Output.jspOutput(outputMap, context, "/support/supportGuarantorForShow.jsp");
			}
		} else {
			outputMap.put("errList", errList) ;
			Output.jspOutput(outputMap, context, "/error.jsp") ;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void upCreditCorpForSupport(Context context) {
		// try {
		...
		try {
			...
			sqlMapper.update("creditVoucher.updateCreditCustomerCorpById",
					context.contextMap);
			Map newData = (Map) DataAccessor.query("creditVoucher.getCreditCustomerCorpById", context.contextMap, RS_TYPE.OBJECT);

			String changeContent = "担保人名称：" + newData.get("CORP_NAME_CN") +"\n"+ getDifferences(oldData,newData);
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(newData.get("PRCD_ID")),null, 
					"业务支撑", "担保人维护", "", changeContent, 1, DataUtil.longUtil(context.contextMap
							.get("s_employeeId")), null, context.contextMap.get("IP").toString());
...
//			}
		...
		if(errList.isEmpty()){
			Output.jspOutput(outputMap, context, "/servlet/defaultDispatcher?__action=creditVoucher.getCreditVouchersShowForSupport&credit_id="+context.contextMap.get("credit_id")+"&commit_flag=1");
...
//			}
		...
		if(errList.isEmpty()){
			Output.jspSendRedirect(context,
					"defaultDispatcher?__action=creditPaylistService.showCreditPaylist&credit_id="
...
//						DataAccessor.execute("creditVoucher.createProperty", map4, DataAccessor.OPERATION_TYPE.INSERT);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void UpCreditNatuForSupport(Context context) {
		int istogether = Integer.parseInt(context.contextMap.get("istogether")
				.toString());
		Map outputMap = new HashMap() ;
		List errList = context.errList ;
...
//			DataAccessor.execute("creditVoucher.updateNatu",
//					context.contextMap, DataAccessor.OPERATION_TYPE.UPDATE);
			Map newData = (Map) DataAccessor.query("creditVoucher.getCreditVoucherNatuById", context.contextMap, RS_TYPE.OBJECT);
			String changeContent =  "自然人名称：" + newData.get("CUST_NAME") +"\n"+ getDifferences(oldData,newData);
			BusinessLog.addBusinessLogWithIp(DataUtil.longUtil(newData.get("PRCD_ID")),null, 
					"业务支撑", "担保人维护", "", changeContent, 1, DataUtil.longUtil(context.contextMap
							.get("s_employeeId")), null, context.contextMap.get("IP").toString());
			// 是联合担保
...
//						DataAccessor.execute("creditVoucher.createProperty", map4, DataAccessor.OPERATION_TYPE.INSERT);
	...
	public void gotoAddVoucherCorpForSupport(Context context) {
		Map outputMap = new HashMap();
		List corpTypeList = null;
		List natuTypeList = null;
		List errList = context.errList ;
		try {
			...
			if(errList.isEmpty()){
				Output.jspOutput(outputMap, context,
						"/support/creditVoucherCorps.jsp");
			} else {
				outputMap.put("errList", errList) ;
				Output.jspOutput(outputMap, context, "/error.jsp") ;
			}
	...
	public void getAllVouch(Context context) {
		...
		Output.jspOutput(outputMap, context, "/credit/creditAllVouch.jsp");
	}
...
//				maps.put("v5", v5);
		...
		if(errList.isEmpty()){
			Output.jspOutput(outputMap, context,
					"/credit/creditAllVouchCorpShow.jsp");
		}else {
			outputMap.put("errList", errList) ;
			Output.jspOutput(outputMap, context, "/error.jsp") ;
		}
	...
	public void getAllVouchNatuShow(Context context) {
		...
		if(errList.isEmpty()){
			Output.jspOutput(outputMap, context,
					"/credit/creditAllVouchNatuShow.jsp");
		} else {
			outputMap.put("errList", errList) ;
			Output.jspOutput(outputMap, context, "/error.jsp") ;
		}
	...
	public void exportExcel(Context context) {
		...
		try {
			baos=exportExcelUtil.exportExcel2(context.contextMap);
	...
	private String getDifferences(Map oldData,Map newData){
		StringBuffer sb = new StringBuffer("");
		Set  keySet  = oldData.keySet();
		Iterator it = keySet.iterator(); 
		  ...
		  { 
		   ...
		   if( !oldValue.equals(newValue)){
			   ...
			   sb.append("变更为");
			   sb.append(String.valueOf(newValue));
			   sb.append("\n");
		   }
		  } 
		return sb.toString();
