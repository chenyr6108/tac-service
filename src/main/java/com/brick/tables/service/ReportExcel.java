...
public class ReportExcel 
{
	...
	public void reportExcelJoin(List list,Map map,Context context)
	{
	...
	public List titleListMethod(Map map)
	{
		...
		String name=(String) map.get("aname");
		String querydate=(String) map.get("QUERYTIME");
		...
		col111.setRow(0);
		col111.setCol(0);
		col111.setContent(name+"办事处"+querydate+"进件统计表");
...
//		titleList.add(col12);
	...
	public List contextListMethod(List contextList)
	{
		...
		//{
			...
			contextListSun.add(contentmap.get("NOWDAY").toString());
