...
package com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app;

public class QueryValidatorServicesServiceLocator extends org.apache.axis.client.Service implements com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesService {
    ...
    public com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices getQueryValidatorServices() throws javax.xml.rpc.ServiceException {
    ...
    public com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices getQueryValidatorServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesSoapBindingStub _stub = new com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices.class.isAssignableFrom(serviceEndpointInterface)) {
                com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesSoapBindingStub _stub = new com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesSoapBindingStub(new java.net.URL(QueryValidatorServices_address), this);
                _stub.setPortName(getQueryValidatorServicesWSDDServiceName());
                return _stub;
            }
        }
