...
public class QueryValidatorServicesProxy implements com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices {
  private String _endpoint = null;
  private com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices queryValidatorServices = null;
  ...
  private void _initQueryValidatorServicesProxy() {
    try {
      queryValidatorServices = (new com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServicesServiceLocator()).getQueryValidatorServices();
  ...
  public com.brick.sms.validator.cn.id5.gboss.businesses.validator.service.app.QueryValidatorServices getQueryValidatorServices() {
    if (queryValidatorServices == null)
      _initQueryValidatorServicesProxy();
